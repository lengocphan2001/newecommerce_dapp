...
let AuditLogController = class AuditLogController {
    ...
    async getStatistics(startDate, endDate) {
        return this.auditLogService.getStatistics(startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
    }
    async getPayoutLogs(query) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuditLogController.prototype, "getStatistics", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuditLogController.prototype, "getPayoutLogs", null);
__decorate([
    (0, common_1.Get)(':id'),
