...
export default function ShippingAddressPage() {
  ...
  // ... (loadAddresses, initializeSelection, handleSelect, handleConfirm, handleDelete remain updated/same)
    ...
    <div className="bg-[#f6f6f8] text-[#0d121b] min-h-screen flex flex-col font-display selection:bg-blue-100 selection:text-blue-900">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-100 px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold tracking-tight">Địa chỉ giao hàng</h1>
        </div>
        <button onClick={handleConfirm} className="text-[#135bec] font-medium text-sm">Xong</button>
      </header>
      ...
      <main className="flex-1 overflow-y-auto pb-48"> 
        ...
        <div className="px-4 mb-2">
          <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Danh sách địa chỉ</h2>
        </div>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
              <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
                  <div className="p-4 border-b border-gray-100 flex justify-between items-center">
                      <h3 className="font-bold text-lg">{editingId ? "Cập nhật địa chỉ" : "Thêm địa chỉ mới"}</h3>
                  ...
                  <form onSubmit={handleAddSubmit} className="p-4 space-y-4">
                      ...
                      <div>
                          <label className="block text-sm font-semibold mb-1.5 text-slate-700">Số điện thoại</label>
                          <input 
                              name="phone"
                              type="tel"
                      ...
                      <div>
                          <label className="block text-sm font-semibold mb-1.5 text-slate-700">Địa chỉ chi tiết</label>
                          <textarea 
                              name="address"
                              rows={3}
                      ...
                      <div className="flex items-center gap-3 py-2">
                           ...
                           />
                           <label htmlFor="isDefaultModal" className="text-sm font-medium text-slate-700">Đặt làm mặc định</label>
                      </div>
                      <button 
                          type="submit"
