      ...
      <main className="flex-1 overflow-y-auto w-full max-w-md mx-auto p-4 pb-32">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary text-white py-4 rounded-xl font-bold shadow-lg shadow-yellow-500/30 active:scale-[0.98] transition-transform disabled:opacity-70"
          >
