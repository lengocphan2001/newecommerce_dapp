...
export const DICT: Record<Lang, Record<I18nKey, string>> = {
  vi: {
    ...
    securePayment: "Thanh toán an toàn qua ví SafePal",
    ...
    safePalWalletLinked: "Ví SafePal đã liên kết",
    saving: "Đang lưu...",
    ...
    connectedToSafePal: "Đã kết nối ví SafePal",
    shopping: "Mua sắm",
    affiliate: "Liên kết",
    assets: "Tài sản",
    ...
    walletConnect: "Kết nối ví SafePal",
    verified: "Xác thực",
  ...
  en: {
    ...
    securePayment: "Secure payment via SafePal wallet",
    ...
    enterPhone: "09xx xxx xxx",
    safePalWalletLinked: "SafePal Wallet Linked",
    saving: "Saving...",
    ...
    connectedToSafePal: "Connected to SafePal",
    shopping: "Shopping",
    affiliate: "Affiliate",
    assets: "Assets",
    ...
    walletConnect: "Connect SafePal Wallet",
    verified: "Verified",
  ...
  ko: {
    ...
    securePayment: "SafePal 지갑을 통한 안전한 결제",
    shippingInfo: "배송 정보",
    connected: "연결됨",
    connect: "연결",
    paymentAsset: "결제 자산",
    ...
    phoneNumber: "전화번호",
    enterPhone: "09xx xxx xxx",
    safePalWalletLinked: "SafePal 지갑 연결됨",
    saving: "저장 중...",
    ...
    totalNetWorth: "총 순자산",
    connectedToSafePal: "SafePal에 연결됨",
    shopping: "쇼핑",
    affiliate: "제휴",
    assets: "자산",
