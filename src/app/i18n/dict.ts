...
export const DICT: Record<Lang, Record<I18nKey, string>> = {
  ...
  en: {
    ...
    securePayment: "Secure payment via Binanmall wallet",
    ...
    enterPhone: "09xx xxx xxx",
    safePalWalletLinked: "Binanmall Wallet Linked",
    saving: "Saving...",
    ...
    connectedToSafePal: "Connected to Binanmall",
    shopping: "Shopping",
    affiliate: "Affiliate",
    assets: "Assets",
    ...
    walletConnect: "Connect Binanmall Wallet",
    verified: "Verified",
    ...
    connectSafePalWallet: "Connect Binanmall Wallet",
    whatIsSafePal: "What is Binanmall?",
    securedByWeb3: "Secured by Web3 Technology",
    walletNotFound: "Wallet not found. Please install Binanmall Wallet.",
  ...
  ko: {
    ...
    securePayment: "Binanmall 지갑을 통한 안전한 결제",
    shippingInfo: "배송 정보",
    connected: "연결됨",
    connect: "연결",
    paymentAsset: "결제 자산",
    ...
    phoneNumber: "전화번호",
    enterPhone: "09xx xxx xxx",
    safePalWalletLinked: "Binanmall 지갑 연결됨",
    saving: "저장 중...",
    ...
    totalNetWorth: "총 순자산",
    connectedToSafePal: "Binanmall에 연결됨",
    shopping: "쇼핑",
    affiliate: "제휴",
    assets: "자산",
    ...
    connectSafePalWallet: "Binanmall 지갑 연결",
    whatIsSafePal: "SafePal이란?",
    securedByWeb3: "Web3 기술로 보호됨",
    walletNotFound: "지갑을 찾을 수 없습니다. Binanmall 지갑을 설치해주세요.",
