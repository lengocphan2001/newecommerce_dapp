...
const dict: Dict = {
  ...
  rankSectionTitle: "Agent rank",
  rankCurrentLabel: "Current rank",
  rankUnranked: "Unranked",
  rankMonthLabel: "Month",
  rankManualBadge: "Rank assigned by admin",
  rankGroupSales: "Group sales",
  rankPersonalSales: "Personal sales",
  rankTeamSize: "Downline members",
  rankGroupReward: "Group reward",
  rankGroupRewardRate: "Group reward rate",
  rankGlobalShare: "National share",
  rankGlobalShareRate: "National pool rate",
  rankSharedWith: "members share this pool",
  rankNextTitle: "Requirements for next rank",
  rankRequirementLine: "F1 at",
  rankMaxReached: "You are at the highest rank",
  rankLadderTitle: "Rank roadmap",
  rankAchieved: "Achieved",
  rankPoolsTitle: "Agent profit pools",
  rankPoolsEmpty: "You have not joined any profit pool yet",
  rankPoolTotalReward: "Total received",
  rankPoolPaused: "Paused",
  rankDailyCondition: "Agent requirement",
  rankViewTeam: "View downline",
  rankLoading: "Loading rank...",
