...
const dict: Dict = {
  ...
  rankSectionTitle: "Cấp bậc đại lý",
  rankCurrentLabel: "Cấp bậc hiện tại",
  rankUnranked: "Chưa xếp hạng",
  rankMonthLabel: "Tháng",
  rankManualBadge: "Cấp bậc do quản trị gán",
  rankGroupSales: "Doanh số nhóm",
  rankPersonalSales: "Doanh số cá nhân",
  rankTeamSize: "Thành viên tuyến dưới",
  rankGroupReward: "Thưởng nhóm",
  rankGroupRewardRate: "Tỷ lệ thưởng nhóm",
  rankGlobalShare: "Đồng chia quốc gia",
  rankGlobalShareRate: "Tỷ lệ bể quốc gia",
  rankSharedWith: "người cùng cấp chia bể",
  rankNextTitle: "Điều kiện lên cấp",
  rankRequirementLine: "F1 đạt",
  rankMaxReached: "Bạn đang ở cấp bậc cao nhất",
  rankLadderTitle: "Lộ trình cấp bậc",
  rankAchieved: "Đã đạt",
  rankPoolsTitle: "Bể đồng chia đại lý",
  rankPoolsEmpty: "Bạn chưa tham gia bể đồng chia nào",
  rankPoolTotalReward: "Tổng đã nhận",
  rankPoolPaused: "Tạm dừng",
  rankDailyCondition: "Điều kiện Đại lý",
  rankViewTeam: "Xem tuyến dưới",
  rankLoading: "Đang tải cấp bậc...",
